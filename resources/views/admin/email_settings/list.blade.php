            ...
            success: function(result) {
                ...
                var html = `<form action="{{ url('admin/payment_methods/update') }}/${id}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" placeholder="John Doe" name="method_name" value="${result.method_name}" required="required"/>
                        </div>
                    </div>
                    <div class="row mb-3">
