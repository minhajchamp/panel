                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="firstName" name="first_name" placeholder="John" autofocus required="required" value="{{ request()->old('first_name') }}" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="lastName" class="form-label">Last Name *</label>
                                    <input class="form-control" type="text" name="last_name" value="{{ request()->old('last_name') }}" id="lastName" placeholder="Doe" required="required" />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="user_organization" name="user_organization" value="Bytrix" disabled />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="user_contact">Phone Number</label>
                                    <div class="input-group input-group-merge">
                                        <!-- <span class="input-group-text">US (+1)</span> -->
                                        <input type="text" id="user_contact" name="user_contact" class="form-control" placeholder="202 555 0111" value="{{ request()->old('user_contact') }}" />
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="user_address" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="user_address" value="{{ request()->old('user_address') }}" name="user_address" placeholder="Address" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="user_state" class="form-label">State</label>
                                    <input class="form-control" type="text" id="user_state" value="{{ request()->old('user_state') }}" name="user_state" placeholder="California" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="user_city" class="form-label">City</label>
                                    <input class="form-control" type="text" id="user_city" value="{{ request()->old('user_city') }}" name="user_city" placeholder="Denver" />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="zipCode" value="{{ request()->old('zipCode') }}" name="zipCode" placeholder="231465" maxlength="6" />
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="user_dob" class="form-label">DOB</label>
                                    <input type="date" class="form-control" id="user_dob" value="{{ request()->old('user_dob') }}" name="user_dob" placeholder="231465" maxlength="6" />
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6 form-password-toggle">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" id="password" class="form-control" name="user_password" required="required" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
